...
use Exceptions\ConnectDatabaseFailException;
use Exceptions\QueryFailException;
...
class DBAccess extends \mysqli
{
     ...
     */
    public function __construct($db, $user, $pass, $host = 'localhost', $port = 3306)
    {
        //Kết nối đến db
    ...
    /**
     * Get the value of DBAccess class
     * @return mixed
     */
    ...
    /**
     * Set the value of DBAccess class
     * @param mixed $prefix
     * @return self
     */
